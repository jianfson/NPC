...
working_path = "/media/jiangxin/data/npc/training/"
file_list=glob(working_path+"images_0000_0015.npy")
...
for fname in file_list:
    ...
    for i in range(len(imgs_to_process)):
        ...
        if i==1:
            ...
            ax[0,1].imshow(node_mask,cmap='gray')
            ax[1,0].imshow(img)
            ax[1,1].imshow(mask*node_mask,cmap='gray')
            plt.show()
